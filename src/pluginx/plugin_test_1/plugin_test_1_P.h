...
public:
	bool Initialize();
	bool InitializeExt( plugin_test_1* strate_test );
	bool StartPlugin( plugin_test_1* strate_test );
	bool IsPluginRun( plugin_test_1* strate_test );
	bool StopPlugin( plugin_test_1* strate_test );
	bool UninitializeExt( plugin_test_1* strate_test );
	bool Uninitialize();
